...
main = scriptInterpreter boostersHeatingUp

type Interpreter = Script -> IO ()

run :: Interpreter -> Script -> IO ()
run interpreter script = interpreter script

scriptInterpreter :: Interpreter
mockInterpreter :: Interpreter
whateverInterpreter :: Interpreter
-- > run scriptInterpreter boostersHeatingUp
